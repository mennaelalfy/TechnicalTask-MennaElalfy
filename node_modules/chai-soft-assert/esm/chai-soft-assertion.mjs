...
export function addSoftMethod(softMethod) {
...
export function addSoftChainableMethod(softChainableMethod) {
...
const flagName = "soft";
export function createSoftAssertion(newSoftMethods = softMethods, newSoftChainableMethods = softChainableMethods) {
...
export const softAssertion = createSoftAssertion(softMethods, softChainableMethods);
